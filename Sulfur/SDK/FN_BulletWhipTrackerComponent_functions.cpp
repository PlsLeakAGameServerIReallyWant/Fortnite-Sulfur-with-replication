...
{
	static auto fn = UObject::FindObject<UFunction>("Function BulletWhipTrackerComponent.BulletWhipTrackerComponent_C.Disable");

	UBulletWhipTrackerComponent_C_Disable_Params params;
