...
public:
	...
	class UParticleSystemComponent*                    WaterInteractionParticle;                                 // 0x05F8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        EmptyStaticMesh;                                          // 0x0600(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneCaptureComponent2D*                    TopDownCaptureActorOfTheWorld;                            // 0x0608(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FVector                                     Camera_Height_Offset;                                     // 0x0648(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	float                                              Particle_Z_Offset;                                        // 0x0654(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               Has_Water_Interaction_Enabled_Variable_Been_Set;          // 0x0658(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               Is_Water_Interaction_Enabled;                             // 0x0659(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FArrayOfWaterMeshWaterBlueprintPairs        Array_Of_Water_Assets;                                    // 0x0670(0x0010) (Edit, BlueprintVisible)
	...
	int                                                Current_Water_Mesh_Index;                                 // 0x0690(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	bool                                               MaterialPairingFound;                                     // 0x06A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x06A9(0x0003) MISSED OFFSET
	struct FLinearColor                                WorldBoundsMinMax;                                        // 0x06AC(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x06BC(0x0004) MISSED OFFSET
	class UMaterialInterface*                          Black_Scene_Capture_Material;                             // 0x06C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FBox                                        Max_level_bounds___used_to_isolate_the_level_from_the_vista;// 0x06C8(0x001C) (Edit, BlueprintVisible, IsPlainOldData)
	...
	bool                                               Storm_Cyl_Mesh_Match;                                     // 0x06F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x06F9(0x0003) MISSED OFFSET
	int                                                Wind_Cyl_Mesh_Array_Match_Index;                          // 0x06FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              Delta_Wind_Falloff_in_World_Units;                        // 0x0700(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FFortWindImpulseHandle                      NewVar_1_2;                                               // 0x0704(0x0004) (Edit, BlueprintVisible, DisableEditOnInstance)
