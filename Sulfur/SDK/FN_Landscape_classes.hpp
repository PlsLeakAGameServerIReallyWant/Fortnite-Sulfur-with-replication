...
public:
	...
	int                                                OccluderGeometryLOD;                                      // 0x0394(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StaticLightingLOD;                                        // 0x0398(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x039C(0x0004) MISSED OFFSET
	class UPhysicalMaterial*                           DefaultPhysMaterial;                                      // 0x03A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              StreamingDistanceMultiplier;                              // 0x03A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x03AC(0x0004) MISSED OFFSET
	class UMaterialInterface*                          LandscapeMaterial;                                        // 0x03B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          LandscapeHoleMaterial;                                    // 0x03B8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0x64];                                      // 0x03F8(0x0064) MISSED OFFSET
	...
	struct FLightingChannels                           LightingChannels;                                         // 0x0468(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData06[0x3];                                       // 0x0469(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0x8];                                       // 0x0498(0x0008) MISSED OFFSET
	...
	unsigned char                                      UnknownData11[0xAA];                                      // 0x06D6(0x00AA) MISSED OFFSET
