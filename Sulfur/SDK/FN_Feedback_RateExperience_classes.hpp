...
public:
	...
	TArray<struct FText>                               TooltipHeaders;                                           // 0x0468(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FText>                               TooltipBodys;                                             // 0x0478(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	class UIconTextButton_C*                           LastClickedStar;                                          // 0x0488(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FText                                       FeedbackTitle;                                            // 0x0490(0x0018) (Edit, BlueprintVisible)
