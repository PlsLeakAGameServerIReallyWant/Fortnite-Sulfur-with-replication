...
public:
	...
	unsigned char                                      UnknownData02[0x127];                                     // 0x0189(0x0127) MISSED OFFSET
	class UCommonListViewNullItem*                     NullItem;                                                 // 0x02B0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	class UCommonTextBlock*                            MyText;                                                   // 0x07D0(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x07D8(0x0018) MISSED OFFSET
...
public:
	...
	bool                                               bAllowInvisibleItemSelection;                             // 0x02C8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
...
public:
	...
	struct FVector2D                                   EntrySpacing;                                             // 0x01F0(0x0008) (Edit, IsPlainOldData)
	struct FSlateChildSize                             EntrySize;                                                // 0x01F8(0x0008) (Edit)
	TEnumAsByte<EHorizontalAlignment>                  EntryHAlign;                                              // 0x0200(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EVerticalAlignment>                    EntryVAlign;                                              // 0x0201(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0202(0x0002) MISSED OFFSET
	int                                                MaxElementSize;                                           // 0x0204(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FVector2D>                           SpacingPattern;                                           // 0x0208(0x0010) (Edit, ZeroConstructor)
	EWidgetClipping                                    EntryClipping;                                            // 0x0218(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EDynamicBoxType                                    BoxType;                                                  // 0x0219(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x16];                                      // 0x021A(0x0016) MISSED OFFSET
